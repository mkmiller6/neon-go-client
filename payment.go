...
type Payment struct {
	...
	TenderType        int32                     `json:"tenderType,omitempty"`
	ReceivedDate      time.Time                 `json:"receivedDate,omitempty"`
	CreditCardOnline  *CreditCardOnlinePayment  `json:"creditCardOnline,omitempty"`
	CreditCardOffline *CreditCardOfflinePayment `json:"creditCardOffline,omitempty"`
	Ach               *ECheckPayment            `json:"ach,omitempty"`
	Check             *CheckPayment             `json:"check,omitempty"`
	Wire              *WirePayment              `json:"wire,omitempty"`
	InKind            *InKindPayment            `json:"inKind,omitempty"`
}
