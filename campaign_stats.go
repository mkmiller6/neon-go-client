...
type CampaignStats struct {
	DonationCount           int32   `json:"donationCount,omitempty"`
	DonationAmount          float64 `json:"donationAmount,omitempty"`
	PledgeCount             int32   `json:"pledgeCount,omitempty"`
	PledgeAmount            float64 `json:"pledgeAmount,omitempty"`
	EventRegistrationCount  int32   `json:"eventRegistrationCount,omitempty"`
	EventRegistrationAmount float64 `json:"eventRegistrationAmount,omitempty"`
