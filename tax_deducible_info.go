...
type TaxDeducibleInfo struct {
	NonDeductibleAmount      float64 `json:"nonDeductibleAmount,omitempty"`
	TaxDeducibleAmount       float64 `json:"taxDeducibleAmount,omitempty"`
	NonDeductibleDescription string  `json:"nonDeductibleDescription,omitempty"`
}
