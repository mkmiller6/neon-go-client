...
type Campaign struct {
	...
	ParentCampaign    *IdNamePair        `json:"parentCampaign,omitempty"`
	PageContent       string             `json:"pageContent,omitempty"`
	Status            string             `json:"status,omitempty"`
	Goal              float64            `json:"goal,omitempty"`
	CampaignPageUrl   string             `json:"campaignPageUrl,omitempty"`
	DonationFormUrl   string             `json:"donationFormUrl,omitempty"`
	Statistics        *CampaignStats     `json:"statistics,omitempty"`
	SocialFundraising *SocialFundraising `json:"socialFundraising,omitempty"`
