...
type CustomFieldData struct {
	...
	ConstituentReadOnly  bool                `json:"constituentReadOnly,omitempty"`
	Component            string              `json:"component,omitempty"`
	OptionValues         []CustomFieldOption `json:"optionValues,omitempty"`
	IsEventSpecificField bool                `json:"isEventSpecificField,omitempty"`
	EventId              string              `json:"eventId,omitempty"`
	AttendeeQuestion     bool                `json:"attendeeQuestion,omitempty"`
	ConstituentName      string              `json:"constituentName,omitempty"`
	PublicName           string              `json:"publicName,omitempty"`
	ConstituentRequired  bool                `json:"constituentRequired,omitempty"`
	PublicRequired       bool                `json:"publicRequired,omitempty"`
	ConstituentVisible   bool                `json:"constituentVisible,omitempty"`
