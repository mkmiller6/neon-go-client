...
type Grant struct {
	...
	FundedDate          time.Time     `json:"fundedDate,omitempty"`
	FundedAmount        float64       `json:"fundedAmount,omitempty"`
	...
	GrantCustomFields   []CustomField `json:"grantCustomFields,omitempty"`
