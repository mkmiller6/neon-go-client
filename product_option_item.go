...
type ProductOptionItem struct {
	...
	AdvantageAmountAdjustment     float64 `json:"advantageAmountAdjustment,omitempty"`
	NonDeductibleAmountAdjustment float64 `json:"nonDeductibleAmountAdjustment,omitempty"`
