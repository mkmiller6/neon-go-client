...
type EventAttendee struct {
	AttendeeId           int32         `json:"attendeeId,omitempty"`
	AccountId            string        `json:"accountId,omitempty"`
	FirstName            string        `json:"firstName,omitempty"`
	LastName             string        `json:"lastName,omitempty"`
	MarkedAttended       bool          `json:"markedAttended,omitempty"`
	AttendeeCustomFields []CustomField `json:"attendeeCustomFields,omitempty"`
