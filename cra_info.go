...
type CraInfo struct {
	AdvantageAmount      float64 `json:"advantageAmount,omitempty"`
	EligibleAmount       float64 `json:"eligibleAmount,omitempty"`
	AdvantageDescription string  `json:"advantageDescription,omitempty"`
}
