...
type SocialFundraising struct {
	// false
	Enabled                bool           `json:"enabled,omitempty"`
	FundraisersCount       int32          `json:"fundraisersCount,omitempty"`
	CreateFundraiserUrl    string         `json:"createFundraiserUrl,omitempty"`
	FundraiserListUrl      string         `json:"fundraiserListUrl,omitempty"`
	FundraisingPageContent string         `json:"fundraisingPageContent,omitempty"`
