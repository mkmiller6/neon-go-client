...
type Donation struct {
	...
	AnonymousType         string            `json:"anonymousType,omitempty"`
	SendAcknowledgeLetter bool              `json:"sendAcknowledgeLetter,omitempty"`
	DonorCoveredFeeFlag   bool              `json:"donorCoveredFeeFlag,omitempty"`
	Purpose               *IdNamePair       `json:"purpose,omitempty"`
	...
	SolicitationMethod    *IdNamePair       `json:"solicitationMethod,omitempty"`
	Acknowledgee          *Acknowledgee     `json:"acknowledgee,omitempty"`
	...
	DonationCustomFields  []CustomField     `json:"donationCustomFields,omitempty"`
