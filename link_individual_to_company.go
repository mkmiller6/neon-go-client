...
type LinkIndividualToCompany struct {
	IndividualContactId string    `json:"individualContactId,omitempty"`
	IsPrimaryContact    bool      `json:"isPrimaryContact,omitempty"`
	CompanyAccountId    string    `json:"companyAccountId,omitempty"`
	IsCurrentEmployee   bool      `json:"isCurrentEmployee,omitempty"`
