...
type EventTicket struct {
	...
	MaxNumberAvailable       int32             `json:"maxNumberAvailable,omitempty"`
	NumberRemaining          int32             `json:"numberRemaining,omitempty"`
	AttendeesPerTicketType   string            `json:"attendeesPerTicketType,omitempty"`
	AttendeesPerTicketNumber int32             `json:"attendeesPerTicketNumber,omitempty"`
