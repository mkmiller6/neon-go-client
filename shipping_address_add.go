...
type ShippingAddressAdd struct {
	AccountId           string        `json:"accountId,omitempty"`
	AddressId           string        `json:"addressId,omitempty"`
	ShippingCompanyName string        `json:"shippingCompanyName,omitempty"`
	ShippingDeliverTo   string        `json:"shippingDeliverTo,omitempty"`
	Type_               *IdNamePair   `json:"type,omitempty"`
	...
	Phone1Type          string        `json:"phone1Type,omitempty"`
	Phone2              string        `json:"phone2,omitempty"`
	Phone2Type          string        `json:"phone2Type,omitempty"`
	Phone3              string        `json:"phone3,omitempty"`
	Phone3Type          string        `json:"phone3Type,omitempty"`
	Fax                 string        `json:"fax,omitempty"`
	FaxType             string        `json:"faxType,omitempty"`
}
